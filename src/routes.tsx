...
import DayTwentyNine from './challenges/daytwentynine';
import DayThirty from './challenges/daythirty';
...
function Routes() {
    return (
        <BrowserRouter>
            ...
            <Route path="/daytwentynine" component={DayTwentyNine}/>
            <Route path="/daythirty" component={DayThirty}/>
        </BrowserRouter>
    )
}
